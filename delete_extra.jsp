...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <title>Delete Extra-Curricular Details</title>
...
%>
   ...
   <div class="container">
            ...
            <form class="form-horizontal" role="form" action="<%= request.getContextPath() %>/DeleteExtra" method="post">
            
            
            <!-- below textfield for updating query like updat where "papername" -->
            
			<div class="form-group1">
                    <label for="updatepaer" style="color: #3002fc "; class="col-sm-9  control-label">Which Extra-Curricular activity you want to delete?</label>
                    <div class="col-sm-9">
                        <input type="text" name="deleteextraname" placeholder="Which Extra-Curricular activity you want to delete?" class="form-control" required  autofocus>
                    </div>
                </div>
               <br>

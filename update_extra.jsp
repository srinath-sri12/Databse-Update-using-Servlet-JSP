...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <title>Update Extra-Curricular Details</title>
...
<%@page import="java.util.*" %>
    ...
    try
    {
		...
		PreparedStatement st=conn.prepareStatement("SELECT * FROM extradetails WHERE Roll_Number=?");
		st.setString(1,st1);
        ...
        rs=st.executeQuery();
        	...
        	while(rs.next()){
        		 String name =rs.getString("Student_Name");
            	        ...
            	        String extraname=rs.getString("Extra_Curricular");
...
%>
   ...
   <div class="container">
            ...
            <form class="form-horizontal" role="form" action="<%= request.getContextPath() %>/UpdateExtra" method="post">
            
            
            <!-- below textfield for updating query like updat where "papername" -->
            
			<div class="form-group1">
                    <label for="updatepaer" style="color: #3002fc "; class="col-sm-9  control-label">Which Extra-Curricular Activities you want to Update?</label>
                    <div class="col-sm-9">
                        <input type="text" name="updateextraname" placeholder="Which Extra-Curricular Activities you want to Update?" class="form-control"   required autofocus>
                    </div>
                </div>
				...
				<div class="form-group">
                    <label for="extra" class="col-sm-3 control-label">Extra-Curricular</label>
                    <div class="col-sm-12">
                        <input type="text" name="extra" placeholder="Extra-Curricular Activities" class="form-control"  autofocus>
                    </div>
                </div>
				...
				<div class="form-group">
                    <label for="place" class="col-sm-3 control-label">Event Place</label>
                    <div class="col-sm-12">
                        <input type="text" name="place" placeholder="Extra-Curricular held place" class="form-control"  autofocus>
                    </div>
                </div>

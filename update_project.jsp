...
<%@page import="java.util.*" %>
    ...
    try
    {
		...
		PreparedStatement st=conn.prepareStatement("SELECT * FROM projectdetails WHERE Roll_Number=?");
		st.setString(1,st1);
...
%>
   ...
   <div class="container">
            ...
            <form class="form-horizontal" role="form" action="<%= request.getContextPath() %>/UpdateProject" method="post">
            
            
            <!-- below textfield for updating query like updat where "projectname" -->
            
			<div class="form-group1">
                    <label for="updatepaer" style="color: #3002fc "; class="col-sm-6  control-label">Which Project you want to update?</label>
                    <div class="col-sm-6">
                        <input type="text" name="updateprojectname" placeholder="Which Project you want to update?" class="form-control" required  autofocus>
                    </div>
                </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" name="project" placeholder="Project Name" class="form-control"  autofocus>
                    </div>
                </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" name="place" placeholder="Project presented place" class="form-control"  autofocus>
                    </div>
                </div>

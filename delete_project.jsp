...
%>
   ...
   <div class="container">
            ...
            <form class="form-horizontal" role="form" action="<%= request.getContextPath() %>/DeleteProject" method="post">
            
            
            <!-- below textfield for updating query like updat where "papername" -->
            
			<div class="form-group1">
                    <label for="updatepaer" style="color: #3002fc "; class="col-sm-6  control-label">Which Project you want to delete?</label>
                    <div class="col-sm-6">
                        <input type="text" name="deleteprojectname" placeholder="Which Project you want to delete?" class="form-control" required  autofocus>
                    </div>
                </div>
               <br>
